...
export const getTodosIfCheckedIs = (checked = false) => Object.values(state.todos)
  .filter((todo) => todo.checked === checked);

export const getNumberIfCheckedIs = (checked = false) => Object.values(state.todos)
  .reduce((prev, todo) => (todo.checked === checked ? prev + 1 : prev), 0);
