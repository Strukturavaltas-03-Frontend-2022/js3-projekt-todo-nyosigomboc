import {addTodo, getTodosIfCheckedIs, getNumberIfCheckedIs, toggle, remove, clearPending, save, tryToReload} from './todo_db.js';
...
const showDate = () => {
  const usDate = new Intl.DateTimeFormat('en-US', { weekday: 'long', year: 'numeric', month: '2-digit', day: '2-digit', });
